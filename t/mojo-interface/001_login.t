...
## test the redirect
$t->post_ok('/login' => form => {email => 'lisa@google.com', password => 'lisa'})
  ->status_is(302)
...
$t->post_ok('/login' => form => {email => 'lisa@google.com', password => 'lisa'})
  ->status_is(200)
	->text_like('a#userOptions' => qr/Welcome:\sLisa\sSimpson/);

## test for a bad password
$t->ua->max_redirects(0);
$t->post_ok('/login' => form => {email => 'lisa@google.com', password => 'wrong_password'})
  ->status_is(302)
