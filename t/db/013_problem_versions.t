...
is_deeply($user_problem_v2_to_delete, $user_problem1_v2,
	'deleteUserProblem: delete a versioned user problem');
...
is_deeply($user_problem_v3_to_delete, $user_problem1_v3,
	'deleteUserProblem: delete another versioned user problem');
