...
import { Problem, ParseableProblem, parseProblem, SetProblem, LibraryProblem, ParseableSetProblem, UserProblem, ParseableUserProblem } from 'src/common/models/problems';
...
export const useSetProblemStore = defineStore('set_problems', {
	...
	actions: {
		...
		// UserProblem actions
		// Fetch all user problems for a course.
