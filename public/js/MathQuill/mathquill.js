...
JS environment could actually contain many instances. */
	...
	function insistOnInterVer() {
		if (window.console) console.warn(
			...
			'  https://github.com/mathquill/mathquill/wiki/' +
			'%60dev%60-branch-(2014%E2%80%932015)-%E2%86%92-v0.10.0-Migration-Guide'
		);
	}
	...
	function getInterface(v) {
		...
		function MQ(el) {
			...
			// same technique as jQuery:
			// https://github.com/jquery/jquery/blob/679536ee4b7a92ae64a5f58d90e9cc38c001e807/src/core/init.js#L92
	...
	Controller.open(function(_) {
		...
		_.delegateMouseEvents = function() {
			...
			this.container.bind('mousedown.mathquill', function(e) {
				...
				// https://github.com/mathquill/mathquill/commit/
				// 8c50028afcffcace655d8ae2049f6e02482346c5#commitcomment-6175800
			});
		};
	});
 ...
 **************************/
	...
	LatexCmds.overrightarrow =
		bind(Style, '\\overrightarrow', 'span', 'class="mq-non-leaf mq-overarrow mq-arrow-right"');
	LatexCmds.overleftarrow =
		bind(Style, '\\overleftarrow', 'span', 'class="mq-non-leaf mq-overarrow mq-arrow-left"');
	LatexCmds.overleftrightarrow =
		bind(Style, '\\overleftrightarrow', 'span', 'class="mq-non-leaf mq-overarrow mq-arrow-both"');
