...
describe('Testing Merged User Problems', () => {
	...
	describe('Creating generic Merged User Problems', () => {

		test('Create a Generic default Merged User Problem', () => {
			const user_problem = new MergedUserProblem();
			expect(user_problem).toBeInstanceOf(MergedUserProblem);
		...
		test('Check that cloning a user problem works', () => {
			...
			expect(prob.clone()).toBeInstanceOf(MergedUserProblem);
		});
	});
